    ...
    <div className="bg-card border border-border rounded-lg p-6">
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          <h3 className="font-semibold text-foreground text-balance">{track.title}</h3>
        ...
        <div className="flex-shrink-0">
          <a href={track.spotifyUrl} target="_blank" rel="noopener noreferrer" className="text-foreground underline">
